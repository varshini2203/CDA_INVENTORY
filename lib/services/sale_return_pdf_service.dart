// lib/services/sale_return_pdf_service.dart
//
// SkyLynk-branded Sale Return / Credit Note PDF — same letterhead, logo
// and visual pattern as EstimatePdfService / DeliveryChallanPdfService,
// adapted for a single-product credit note (reason for return, reference
...
class SaleReturnPdfService {
  ...
  // ═══════════════════════════════════════════════════════════════════════
  // SALE RETURN / CREDIT NOTE — matches the SkyLynk Estimate layout
  // ═══════════════════════════════════════════════════════════════════════
  static Future<Uint8List> generate(SaleReturn ret) async {
      ...
      pw.Page(
        ...
        build: (context) => pw.Column(
          ...
          children: [
            ...
            pw.Center(
              child: pw.Text('Sale Return / Credit Note',
                ...
                pw.Expanded(
                  ...
                  child: pw.Column(
                    ...
                    children: [
                      ...
                      pw.Text(ret.customerName.isEmpty ? '-' : ret.customerName,
