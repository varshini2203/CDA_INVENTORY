// lib/screens/purchases/add_purchase_return_screen.dart
//
// "Add Purchase Return / Dr. Note" — restyled to match the Add Purchase
// Order theme: navy AppBar, light workspace tab strip, white bordered
// cards, kBlue accents, same field decoration / spacing / typography.
// All existing Firebase/Firestore business logic (PurchaseReturn model,
// PurchaseReturnService, validation, branch list, success dialog) is
// preserved unchanged.
...
class _AddPurchaseReturnScreenState extends State<AddPurchaseReturnScreen> {
  ...
  // ── Product / Vendor  +  Reference / Reason / Branch / Return Date ──
    ...
    return LayoutBuilder(builder: (context, constraints) {
      ...
      final productBlock = Column(crossAxisAlignment: CrossAxisAlignment.stretch, children: [
        ...
        TextFormField(
          ...
          decoration: _fieldDecoration(hint: 'e.g. A4 Sheets, Drone Battery'),
        ...
        TextFormField(
          ...
          style: const TextStyle(color: kTextDark, fontSize: 13),
          textCapitalization: TextCapitalization.words,
          decoration: _fieldDecoration(hint: 'e.g. ABC Stationery').copyWith(
  ...
  Widget _summaryCard() {
    ...
    return Column(crossAxisAlignment: CrossAxisAlignment.stretch, children: [
      ...
      Row(crossAxisAlignment: CrossAxisAlignment.center, children: [
        const Text('Return Amount', style: TextStyle(fontSize: 14, fontWeight: FontWeight.w800, color: kTextDark)),
        const Spacer(),
        Container(
